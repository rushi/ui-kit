...
import { CalendarDayIcon, CalendarMonthIcon, CalendarWeekIcon, MenuIcon } from "../../icons/index";

const meta: Meta<typeof PopoverList> = {
    id: "PopoverList",
...
export default meta;
type Story = StoryObj<typeof PopoverList>;
