...
const meta: Meta<typeof Popover> = {
    ...
    argTypes: {
        ...
        skidding: getArgument(0, "number", null, "The amount in pixels to offset along the reference"),
        distance: getArgument(10, "number", null, "The amount in pixels to displace the popover"),
